...
// framework : MapStruct qui permet de converter d'un objet a un autre, on a besoin seulement de creer la signature de fonction
...
public class BankAccountMapperImpl
{
    ...
    public CurrentBankAccountDTO fromCurrentBankAccount(CurrentAccount currentBanckAcount){
    ...
    public CurrentAccount fromCurrentBankAccountDTO(CurrentBankAccountDTO currentBanckAcountDTO){
